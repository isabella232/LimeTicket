...
class TableMember extends JTable
{
	...
	function TableMember(& $db) {
		parent::__construct('#__limeticket_ticket_group_members', 'user_id', $db);
	}
	...
	function delete_member($userid, $groupid)
	{
		...
		$query = 'DELETE FROM '.$this->_tbl.
				" WHERE user_id = '".LIMETICKETJ3Helper::getEscaped($this->_db,$userid)."' AND group_id = '".LIMETICKETJ3Helper::getEscaped($this->_db,$groupid)."' ";

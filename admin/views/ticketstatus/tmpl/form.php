...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketstatus->title);?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="userdisp" id="userdisp" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketstatus->userdisp);?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="color" id="color" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketstatus->color);?>" />
			</td>
		</tr>
		<tr>
			<td width="135" align="right" class="key">

...
<form action="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=listusers' );?>" method="post" name="adminForm" id="adminForm">
<style>
table.adminlist td
{
	padding-top:0px;
...
<?php
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = LIMETICKETRoute::_( 'index.php?option=com_limeticket&controller=listuser&task=adduser&tmpl=component&cid[]='. $row->id . '&groupid=' . JRequest::getVar('groupid') );

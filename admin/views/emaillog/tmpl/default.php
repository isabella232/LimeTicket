...
<form action="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=emaillog' );?>" method="post" name="adminForm" id="adminForm">
<p>
...
<?php foreach ($this->rows as $row): ?>
	...
	<tr>
		<td style="white-space: nowrap;">
			<?php echo LIMETICKET_Helper::Date($row->firstseen,LIMETICKET_DATETIME_MYSQL); ?>
		</td>
		<td>
		...
		<td style="white-space: nowrap;">
			<?php echo LIMETICKET_Helper::Date($row->lastseen,LIMETICKET_DATETIME_MYSQL); ?>
</td>
<td>
<?php 
$log = str_replace("\n", "<br />", $row->oldlog);
...
?>
			<a href="#" onclick="return false;" data-placement="left" class="limeticketTip" title="<?php echo $log; ?>">Log</a>
		</td>	
	</tr>
<?php endforeach; ?>
	</table>	

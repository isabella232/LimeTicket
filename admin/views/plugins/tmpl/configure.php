...
<form name="adminForm" id="adminForm" class="form-condensed form-horizontal" action="<?php echo JRoute::_('index.php?option=com_limeticket&view=plugins&layout=configure&type=' . $this->plugin->type . "&name=" . $this->plugin->name); ?>" method="post">

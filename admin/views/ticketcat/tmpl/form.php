...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketcat->title);?>" />
			</td>
			<td>
				<div id="trprev_title"></div>
			</td>
		</tr>
		<?php LIMETICKETAdminHelper::LA_Form($this->ticketcat, true); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="section">
			...
			<td>
				<input class="text_area" type="text" name="section" id="section" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketcat->section);?>" />
			</td>
			<td>

	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			<tr>
				...
				<td><div class="limeticket_help"><?php echo JText::_('TMPLHELP_comments_general_use_custom'); ?></div></td>
			</tr>
			...
			<tr id="comments_general_row">
				<td valign="top" align="right" class="key" style="width:150px;">
					...
					<span class='limeticket_custom_warn'>
				...
				<td><div class="limeticket_help"><?php echo LIMETICKETAdminHelper::IncludeHelp("comment.htm"); ?></div></td>
			</tr>
		</table>
	</fieldset>
	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			<tr>
				...
				<td><div class="limeticket_help"><?php echo JText::_('TMPLHELP_comments_announce_use_custom'); ?></div></td>
			</tr>
	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			<tr>
				...
				<td><div class="limeticket_help"><?php echo JText::_('TMPLHELP_comments_kb_use_custom'); ?></div></td>
			</tr>
	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			<tr>
				...
				<td><div class="limeticket_help"><?php echo JText::_('TMPLHELP_comments_test_use_custom'); ?></div></td>
			</tr>
			...
			<tr>
				...
				<td><div class="limeticket_help"><?php echo JText::_('TMPLHELP_comments_testmod_use_custom'); ?></div></td>
			</tr>

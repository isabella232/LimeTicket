...
?>
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
				...
				<td><div class="limeticket_help"><?php echo JText::_('TMPLHELP_announce_use_custom'); ?></div></td>
			</tr>
			...
			<tr id="announce_row">
				...
				<td>
					<div class="limeticket_help">
						<?php echo LIMETICKETAdminHelper::IncludeHelp("announce_list.htm"); ?>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td><div class="limeticket_help"><?php echo JText::_('TMPLHELP_announcesingle_use_custom'); ?></div></td>
			</tr>
			...
			<tr id="announcesingle_row">
				...
				<td>
					<div class="limeticket_help">
						<?php echo LIMETICKETAdminHelper::IncludeHelp("announce_single.htm"); ?>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td><div class="limeticket_help"><?php echo JText::_('TMPLHELP_announcemod_use_custom'); ?></div></td>
			</tr>
			...
			<tr id="announcemod_row">
				...
				<td>
					<div class="limeticket_help">
						<?php echo LIMETICKETAdminHelper::IncludeHelp("announce_module.htm"); ?>
					</div>
				</td>
			</tr>

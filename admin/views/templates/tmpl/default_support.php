		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			...
			<tr id="customtemplaterow">
				...
				<td style="width:450px;" valign="top">
					<span class='limeticket_custom_warn'><?php echo JText::_('TMPLHELP_WARN1'); ?></span><br>
				...
				<td valign="top">
					<div class="limeticket_help">
						<?php echo LIMETICKETAdminHelper::IncludeHelp("support_template.htm"); ?>
						<?php echo LIMETICKETAdminHelper::IncludeHelp("support_template_admin.htm"); ?>
					</div>
				</td>
			</tr>
			...
			<tr id="customusertemplaterow">
				...
				<td valign="top">
					<div class="limeticket_help">
						<?php echo LIMETICKETAdminHelper::IncludeHelp("support_template.htm"); ?>
						<?php echo LIMETICKETAdminHelper::IncludeHelp("support_template_user.htm"); ?>
					</div>
				</td>
			</tr>
		</table>

...
?>
<div class="limeticket_main limeticket_settings">
...
<form action="<?php echo JURI::root(); ?>/index.php?view=admin_support&option=com_limeticket&preview=1" method="post" name="adminForm2" id="adminForm2" target="_blank">

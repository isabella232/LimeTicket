...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->announce->title);?>" />
			</td>
		</tr>
		<?php LIMETICKETAdminHelper::LA_Form($this->announce); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="title">
			...
			<td>
				<input class="text_area" type="text" name="subtitle" id="subtitle" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->announce->subtitle);?>" />
			</td>
		</tr>
		<tr>
			<td width="135" align="right" class="key">

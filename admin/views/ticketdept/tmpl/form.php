	...
	<fieldset class="adminform">
		...
		<table class="admintable">
			<tr>
				...
				<td>
					<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketdept->title);?>" />
				</td>
				<td>
					<div id="trprev_title"></div>
				</td>
			</tr>
			<?php LIMETICKETAdminHelper::LA_Form($this->ticketdept, true); ?>
			<tr>
				<td width="135" align="right" class="key">
					<label for="image">
				...
				<td>
					...
					<?php echo JText::_("FOUND_IN_IMAGES_LIMETICKET_DEPARTMENTS"); ?>
				</td>
			</tr>		
			<tr>
			    <td width="135" align="right" class="key">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="category" id="category" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketdept->category);?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="subcat" id="subcat" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketdept->subcat);?>" />
			</td>
			<td>

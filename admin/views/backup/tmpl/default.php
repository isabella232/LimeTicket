...
<table>
	<tr>
		<th>Username:</th>
		<td><input id="username" type='text' name="username" value="<?php echo LIMETICKET_Settings::get('fsj_username'); ?>"></td>
	</tr>
	<tr>
		<th>API Key:</th>
		<td><input id="apikey" type='text' name="apikey" size="60" value="<?php echo LIMETICKET_Settings::get('fsj_apikey'); ?>"></td>
	</tr>
	<tr>
...
<a class='btn btn-default' href='<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=backup&task=update"); ?>'><?php echo JText::_("PROCESS_FREESTYLE_JOOMLA_INSTALL_UPDATE"); ?></a><br />&nbsp;<br />
...
<form action="<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=backup&task=restore"); ?>"  method="post" name="adminForm2" id="adminForm2" enctype="multipart/form-data"></::>

...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="created" id="created" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->test->created);?>" /> 
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="name" id="name" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->test->name);?>" />
			</td>
		</tr>
		<tr>
			<td align="right" class="key">
			...
			<td>
				<input class="text_area" type="text" name="email" id="email" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->test->email);?>" />
			</td>
		</tr>
		<tr>
			<td align="right" class="key">
			...
			<td>
				<input class="text_area" type="text" name="website" id="website" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->test->website);?>" />
			</td>
		</tr>
		<tr>
			<td align="right" class="key">
...
function change_section()
{
	...
	var url = '<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&controller=test&task=ident&ident=XXX', false); ?>';

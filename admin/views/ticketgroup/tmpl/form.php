...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="groupname" id="groupname" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketgroup->groupname);?>" />
			</td>
		</tr>
		<tr>
			<td width="135" align="right" class="key">
			...
			<td>
				<input class="text_area" type="text" name="description" id="description" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketgroup->description);?>" />
			</td>
		</tr>
		<tr>

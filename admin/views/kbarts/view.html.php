...
class LimeticketsViewKbarts extends JViewLegacy
{
  
    function display($tpl = null)
    {
        JToolBarHelper::title( JText::_("KNOWLEDGE_BASE_ARTICLES"), 'limeticket_kb' );
		...
		$query = 'SELECT id, title, parcatid, ordering FROM #__limeticket_kb_cat ORDER BY ordering';
		...
		$query = 'SELECT id, title FROM #__limeticket_prod ORDER BY ordering';

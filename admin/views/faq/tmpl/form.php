...
<div>
	<fieldset class="adminform">
		...
		<?php LIMETICKETAdminHelper::LA_Form($this->faq); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="question">
			...
			<td>
				<textarea name="question" id="question" cols="80" rows="4" style="width:544px;"><?php echo LIMETICKET_Helper::escape($this->faq->question);?></textarea>
			</td>
		</tr>
		<tr>
			<td width="135" align="right" class="key">

...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->faqcat->title);?>" />
			</td>
		</tr>
		<?php LIMETICKETAdminHelper::LA_Form($this->faqcat); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="image">
			...
			<td>
				...
				<?php echo JText::_("FOUND_IN_IMAGES_LIMETICKET_FAQCATS"); ?>
			</td>
		</tr>		
		<tr>
			<td width="135" align="right" class="key">

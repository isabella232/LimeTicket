...
?>
<form action="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=ticketdepts' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = LIMETICKETRoute::_( 'index.php?option=com_limeticket&controller=ticketdept&task=edit&cid[]='. $row->id );
        ...
        <tr class="<?php echo "row$k"; ?>">
			...
			<td>
				...
				<?php } else { ?>
				<?php $link = LIMETICKETRoute::_('index.php?option=com_limeticket&tmpl=component&controller=ticketdept&view=ticketdept&task=prods&ticket_dept_id=' . $row->id); ?>

	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_main_show_prod'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_main_show_cat'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_main_show_sidebyside'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_main_show_search'); ?></div>
				</td>
			</tr>
	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_main_prod_colums'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_main_prod_search'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_main_prod_pages'); ?></div>
				</td>
			</tr>
	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_main_cat_mode'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_main_cat_colums'); ?></div>
				</td>
			</tr>
	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_prod_cat_mode'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_prod_cat_arts'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_prod_cat_colums'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_prod_search'); ?></div>
				</td>
			</tr>
	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_cat_cat_mode'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_cat_cat_arts'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_cat_art_pages'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_cat_search'); ?></div>
				</td>
			</tr>	
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_kb_cat_desc'); ?></div>
				</td>
			</tr>

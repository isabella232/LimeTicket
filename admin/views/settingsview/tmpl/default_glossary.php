	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('view_help_glossary_use_letter_bar'); ?></div>
				</td>
			</tr>
			<tr>
				<td align="right" class="key" style="width:250px;">
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('How should the long description be displayed'); ?></div>
				</td>
			</tr>
			<tr>
				<td align="right" class="key" style="width:250px;">
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('sethelp_glossary_show_search'); ?></div>
				</td>
			</tr>		</table>
	</fieldset>

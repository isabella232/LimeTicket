	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_FAQS_HIDE_ALLFAQS'); ?></div>
				</td>
			</tr>
			<tr>
				<td align="right" class="key" style="width:250px;">
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_FAQS_hide_tags'); ?></div>
				</td>
			</tr>
			<tr>
				<td align="right" class="key" style="width:250px;">
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_FAQS_hide_search'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_FAQS_show_featured'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_NUM_CAT_COLUMS'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_view_mode_cat'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_faqs_view_mode_incat'); ?></div>
				</td>
			</tr>
	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_faqs_view_mode'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_FAQS_enable_pages'); ?></div>
				</td>
			</tr>

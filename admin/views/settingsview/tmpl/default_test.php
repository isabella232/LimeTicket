	...
	<fieldset class="adminform">
		...
		<table class="table table-bordered table-condensed table-striped table-settings">
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_test_show_prod_mode'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_test_pages'); ?></div>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<div class='limeticket_help'><?php echo JText::_('VIEWHELP_test_always_prod_select'); ?></div>
				</td>
			</tr>

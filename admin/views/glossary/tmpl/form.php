...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="word" id="word" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->glossary->word);?>" />
			</td>
		</tr>
		<?php LIMETICKETAdminHelper::LA_Form($this->glossary); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="word">
		...
		<tr>
			...
			<td>
				...
				<textarea name="altwords" cols="80" rows="6" style="width:100%"><?php echo LIMETICKET_Helper::encode($this->glossary->altwords); ?></textarea>				
            </td>
		</tr>
		<tr>
			<td width="135" align="right" class="key">

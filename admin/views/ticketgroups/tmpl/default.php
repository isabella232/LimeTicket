...
?>
<form action="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=ticketgroups' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    for ($i=0, $n=count( $this->data ); $i < $n; $i++)
    {
        ...
        $link = LIMETICKETRoute::_( 'index.php?option=com_limeticket&controller=ticketgroup&task=edit&cid[]='. $row->id );
        ...
        <tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<a href="<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=members&groupid={$row->id}"); ?>" style="position:relative;top:-3px;" title="Edit Members">
				<img src="<?php echo JURI::root( true ); ?>/administrator/components/com_limeticket/assets/members.png" width="16" height="16" style="position:relative;top:3px;">	
				<?php 
				if ($row->cnt == 0)
				{
			...
			<td>
				...
				<?php } else { ?>
					...
					$qry = "SELECT * FROM #__limeticket_ticket_group_prod as gp LEFT JOIN ";
					$qry .= " #__limeticket_prod as p ON gp.prod_id = p.id WHERE ";

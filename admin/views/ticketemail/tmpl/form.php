...
<div class="col100">
	<fieldset class="adminform">
		...
		<tr>
			...
			<td colspan="2">
				<input class="text_area" type="text" name="name" id="name" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->item->name);?>" />
			</td>
		</tr>		<tr>
			...
			<td colspan="2">
				<input class="text_area" type="text" name="server" id="server" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->item->server);?>" />
			</td>
		</tr>		
		<tr>
			<td align="right" class="key">
		...
		<tr>
			...
			<td colspan="2">
				<input class="text_area" type="text" name="port" id="port" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->item->port);?>" />
			</td>
		</tr>		<tr>
			<td align="right" class="key">
				<label for="name">
			...
			<td colspan="2">
				<input class="text_area" type="text" name="username" id="username" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->item->username);?>" />
			</td>
		</tr>		
		<tr>
			<td align="right" class="key">
			...
			<td colspan="2">
				<input class="text_area" type="password" name="password" id="password" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->item->password);?>" />
			</td>
		</tr>		
		<tr>
			<td align="right" class="key">
			...
			<td colspan="2">
				<input class="text_area" type="text" name="checkinterval" id="checkinterval" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->item->checkinterval);?>" />
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="2">
				<input class="text_area" type="text" name="connectstring" id="connectstring" style="width: 100%" size="80" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->item->connectstring);?>" />

...
class limeticketsViewticketemail extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_( 'TICKET_EMAIL_ACCOUNT' ).': <small><small>[ ' . $text.' ]</small></small>', 'limeticket_emailaccounts' );

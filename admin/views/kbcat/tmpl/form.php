...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->kbcat->title);?>" />
			</td>
		</tr>
		<?php LIMETICKETAdminHelper::LA_Form($this->kbcat); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="title">
		...
		<tr>
			...
			<td>
				...
				<?php echo JText::_("FOUND_IN_IMAGES_LIMETICKET_KBCATS"); ?>
			</td>
		</tr>		
		<tr>
			<td width="135" align="right" class="key">

...
class LimeticketsViewKbcat extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_("KNOWLEDGE_BASE_CATEGORY").': <small><small>[ ' . $text.' ]</small></small>', 'limeticket_categories' );
		...
		$path = JPATH_SITE.DS.'images'.DS.'limeticket'.DS.'kbcats';
		...
		if ($kbcat->id)
			$query .= " WHERE id != '".LIMETICKETJ3Helper::getEscaped($db, $kbcat->id)."' ";

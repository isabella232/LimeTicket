...
<form action="index.php?option=com_limeticket&view=permission&section=<?php echo $this->section; ?>&task=save" method="post" name="compForm" id="compForm">
...
<form action="index.php?option=com_limeticket&view=permission&section=<?php echo $this->section; ?>&task=save" method="post" name="adminForm" id="adminForm">
...
<?php if ($this->section == "com_limeticket.support_admin"): ?>
	<div class="tabbable">
				...
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="t_admin_view_products">
							...
							<?php echo LIMETICKET_Admin_Permissions::prep_custom_rules($this->form, "view_products", "products", 'limeticket.handler.view.product', 'perm_vp')->input; ?>
						</div>
						...
						<div class="tab-pane" id="t_admin_view_departments">
							...
							<?php echo LIMETICKET_Admin_Permissions::prep_custom_rules($this->form, "view_departments", "departments", 'limeticket.handler.view.department', 'perm_vd')->input; ?>
						</div>
						...
						<div class="tab-pane" id="t_admin_view_categories">
							...
							<?php echo LIMETICKET_Admin_Permissions::prep_custom_rules($this->form, "view_categories", "categories", 'limeticket.handler.view.category', 'perm_vc')->input; ?>
						</div>
				...
				<div class="tabbable">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="t_admin_assign_products">
							...
							<?php echo LIMETICKET_Admin_Permissions::prep_custom_rules($this->form, "assign_products", "products", 'limeticket.handler.assign.product', 'perm_ap')->input; ?>
						</div>
						...
						<div class="tab-pane" id="t_admin_assign_departments">
							...
							<?php echo LIMETICKET_Admin_Permissions::prep_custom_rules($this->form, "assign_departments", "departments", 'limeticket.handler.assign.department', 'perm_ad')->input; ?>
						</div>
						...
						<div class="tab-pane" id="t_admin_assign_categories">
							...
							<?php echo LIMETICKET_Admin_Permissions::prep_custom_rules($this->form, "assign_categories", "categories", 'limeticket.handler.assign.category', 'perm_ac')->input; ?>
						</div>				
					</div>
				</div>
			</div>
...
<?php elseif ($this->section == "com_limeticket.reports"): ?>

	<?php echo LIMETICKET_Admin_Permissions::prep_custom_rules($this->form, "rules", "reports", 'limeticket.reports.report', 'reports')->input; ?>
...
Joomla.submitbutton = function(pressbutton) {
	...
	if (pressbutton == "nojs")
	{
		window.location = '<?php echo JRoute::_("index.php?option=com_limeticket&view=permission&section=support_admin&nojs=1", false); ?>';
		return;
	}

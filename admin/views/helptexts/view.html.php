...
class LimeticketsViewHelpTexts extends JViewLegacy
{
 
    function display($tpl = null)
    {
		JToolBarHelper::title( JText::_("Help Text Manager"), 'limeticket_helptexts' );
		...
		$query = 'SELECT `group` as id, `group` as title FROM #__limeticket_help_text GROUP BY `group` ORDER BY `group`';

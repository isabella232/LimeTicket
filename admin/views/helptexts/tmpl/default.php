...
<form action="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=helptexts' );?>" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
    ...
    {
        $row = $this->data[$i];
    	$link = JRoute::_( 'index.php?option=com_limeticket&controller=helptext&task=edit&identifier='. $row->identifier );
        ...
        <tr class="<?php echo "row$k"; ?>">
			...
			<?php 
				...
				$link = "index.php?option=com_limeticket&controller=helptext&task=" . $task . "&identifier=" . $row->identifier;
			?>

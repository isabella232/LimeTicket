...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketpri->title);?>" />
			</td>
			<td>
				<div id="trprev_title"></div>
			</td>
		</tr>
		<?php LIMETICKETAdminHelper::LA_Form($this->ticketpri, true); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="title">
			...
			<td>
				<input class="text_area" type="text" name="color" id="color" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketpri->color);?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="backcolor" id="backcolor" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->ticketpri->backcolor);?>" />
			</td>
			<td>

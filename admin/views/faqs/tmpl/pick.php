...
?>
<form action="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&task=pick&controller=faq&tmpl=component' );?>" method="post" name="adminForm" id="adminForm">

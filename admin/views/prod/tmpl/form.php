...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->prod->title);?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="category" id="category" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->prod->category);?>" />
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="subcat" id="subcat" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->prod->subcat);?>" />
			</td>
			<td>
				<div id="trprev_subcat"></div>
			</td>
		</tr>		
		<?php LIMETICKETAdminHelper::LA_Form($this->prod, true); ?>
		<tr>
			<td width="135" align="right" class="key">
				<label for="image">
			...
			<td>
				...
				<?php echo JText::_("FOUND_IN_IMAGES_LIMETICKET_PRODUCTS"); ?>
			</td>
		</tr>		
		<tr>
			<td width="135" align="right" class="key">

	...
	<fieldset class="adminform">
		...
		<table class="admintable">
			...
			<tr>
			    ...
			    <td>
				    <input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->kbart->title);?>" />
			    </td>
		    </tr>
		<?php LIMETICKETAdminHelper::LA_Form($this->kbart); ?>
			<tr>
			    <td width="135" align="right" class="key">
				    <label for="eh">
		    ...
		    <tr>
			    ...
			    <td>
				    ...
				    <?php foreach ($this->lists['related'] as $relart) : ?>
						<div id="relart_<?php echo $relart['id']; ?>" class="limeticket_kb_relart"><a href="javascript: return null;" onclick="removerelart(<?php echo $relart['id']; ?>); return false;"><img src='<?php echo JURI::base(); ?>/components/com_limeticket/assets/cross.png' width='16' height='16' /> <?php echo JText::_("REMOVE"); ?></a> - <?php echo $relart['title']; ?></div>
					...
					<div class="button2-left" style="clear:both;">
						<div class="blank">
							<a href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&task=pick&tmpl=component&controller=kbart') ?>" class="modal" rel="{handler: 'iframe', size: {x: 650, y: 375}}">Add Related Article</a>
						</div>
					</div>
                </td>
		    </tr>
            <tr>
                <td width="135" align="right" class="key">
                    <label for="filedata">
                        <?php echo JText::_("UPLOAD_FILE"); ?> (Max <?php echo LIMETICKET_Helper::display_filesize(LIMETICKET_Helper::getMaximumFileUploadSize()); ?>)
                    </label>
                </td>
                <td>        
            ...
            <tr>
                ...
                <td> 
                    <table class="admintable table table-bordered table-condended" style="margin-left: 8px;">       
						...
						<tr>
							<?php $filelink = LIMETICKETRoute::_( 'index.php?option=com_limeticket&controller=kbart&task=download&fileid=' . $file['id'] ); ?>
							<td nowrap>
                                <a href='<?php echo $filelink; ?>' alt='Download'>
									<img src='<?php echo JURI::base(); ?>/components/com_limeticket/assets/disk.png' width='16' height='16' />
								</a>
...
function jSelectArticle(id, title, field)
{
	...
	$('relarts').innerHTML = $('relarts').innerHTML + '<div id="relart_' + id + '" class="limeticket_kb_relart"><a href="javascript: return null;" onclick="removerelart(' + id + '); return false;"><img src="<?php echo JURI::base(); ?>/components/com_limeticket/assets/cross.png" width="16" height="16" /> <?php echo JText::_("REMOVE"); ?></a> - ' + title + '</div>';				
}

...
function IncludeHelp($tmpl)
{
	if ($tmpl == "comment")
	{
		return LIMETICKETAdminHelper::IncludeHelp('email_comment.html');
	} elseif ($tmpl == "messagerow")
	{
		return LIMETICKETAdminHelper::IncludeHelp('email_messagerow.html');
	} else {
		return LIMETICKETAdminHelper::IncludeHelp('email_support.html');
	}
}
...
<div class="tabbable">
	...
	<ul class="nav nav-tabs" id="main_tabs">
		<li class="active"><a href="#t_content"><?php echo JText::_('LIMETICKET_CONTENT'); ?></a></li>
			...
			<div class="tabbable tabs-left">
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="t_general_reports">
						<?php echo LIMETICKET_Admin_Permissions::prep_custom_rules($this->form, "reports", "reports", 'limeticket.reports.report', 'reports')->input; ?>
					</div>

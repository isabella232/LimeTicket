...
<?php echo LIMETICKET_Helper::PageStylePopup(1); ?>

<?php echo LIMETICKET_Helper::PageTitlePopup('SUPPORT_ADMIN',"LIST_HANDLERS"); ?>

<form id="mainform" name="mainform" action="<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=perminfo&tmpl=component"); ?>" method="post" class="form-inline form-condensed">

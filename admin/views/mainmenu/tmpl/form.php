...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td colspan="2">
				<input class="text_area" type="text" name="title" id="title" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->mainmenu->title);?>" />
			</td>
			<td>
				<div id="trprev_title"></div>
			</td>
		</tr>
		<?php LIMETICKETAdminHelper::LA_Form($this->mainmenu); ?>
		<tr>
			<td width="135" align="right" class="key">
		...
		<tr>
			...
			<td colspan="2">
				...
				<?php echo JText::_("FOUND_IN_IMAGES_LIMETICKET_MENU"); ?>
			</td>
		</tr>
		<tr>
			<td width="135" align="right" class="key">
		...
		<?php endif; ?>
		<input type="hidden" name="itemid" id="itemid" value="<?php echo LIMETICKET_Helper::escape($this->mainmenu->itemid);?>" />
		<!--<input type="hidden" name="link" id="link" value="<?php echo LIMETICKET_Helper::escape($this->mainmenu->link);?>" />-->
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="link" id="link" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->mainmenu->link);?>" />
			</td>
		...
		<tr>
			...
			<td>
				<input type="text" name="target" id="target" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->mainmenu->target);?>" />
			</td>
			<td><?php echo JText::_('ONLY_WHEN_LINK'); ?></td>
		</tr>
		<?php //endif; ?>

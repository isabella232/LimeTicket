...
class LimeticketsViewMainmenu extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		JToolBarHelper::title(   JText::_("MENU_ITEM").': <small><small>[ ' . $text.' ]</small></small>', 'limeticket_menu' );
		...
		$path = JPATH_SITE.DS.'images'.DS.'limeticket'.DS.'menu';
		...
		{
			$menus = LIMETICKET_GetMenus($mainmenu->itemtype);

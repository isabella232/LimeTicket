...
{
	var url = '<?php echo JRoute::_('index.php?option=com_limeticket&view=translate&tmpl=component', false); ?>&data=' + encodeURIComponent(JSON.stringify(to_translate));
...
function plugin_changed()
{
	...
	var url = '<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&controller=field&task=plugin_form', false); ?>&plugin=' + jQuery('#plugin').val();
...
<div>
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="description" id="description" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->field->description);?>" />
			</td>
		</tr>
		<tr>
		    <td width="135" align="right" class="key">
		    ...
		    <td>
				<input class="text_area" type="text" name="alias" id="alias" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->field->alias);?>" />
		    </td>
	    </tr>		
		<?php LIMETICKETAdminHelper::LA_Form($this->field, true); ?>
		<tr>
		    <td width="135" align="right" class="key">
			    <label for="eh">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="default" id="default" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->field->default);?>" />
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="blankmessage" id="blankmessage" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->field->blankmessage);?>" /><br>
            </td>
		</tr>		<tr>
			<td width="135" align="right" class="key" valign="top">
				<label for="description">
			...
			<td>
				<textarea name="javascript" id="javascript" cols="80" rows="6" style="width:544px;"><?php echo LIMETICKET_Helper::escape($this->field->javascript);?></textarea>
...
<div id="ticket_field_settings">
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				<input class="text_area" type="text" name="grouping" id="grouping" size="32" maxlength="250" value="<?php echo LIMETICKET_Helper::escape($this->field->grouping);?>" />

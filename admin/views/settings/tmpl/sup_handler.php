		...
		<fieldset class="adminform">
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_delete'); ?></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SUPPORT_ADMIN_REFRESH'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_hide_super_users'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_no_admin_for_user_open'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_profile_itemid'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_allow_edit_no_audit'); ?></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_lock_time'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_update_satatus_on_draft'); ?></div>
					</td>
				</tr>				
			</table>
		</fieldset>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_autoassign'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						...
						<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_handler_fallback'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_assign_reply'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">				
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SUPPOER_CHOOSE_HANDLER'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('WHEN_A_HANDLER_OPENS_A_TICKET_FOR_A_USER__SHOULD_THEY_BE_ASSIGNED_AS_THE_HANDLER'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_forward_product_handler'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_forward_handler_handler'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('sethelp_suport_dont_cc_handler'); ?></div>
					</td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_advanced_default'); ?></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_basic_name'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_basic_username'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_basic_email'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_basic_messages'); ?></div>
					</td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_time_tracking'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_time_tracking_require_note'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_time_tracking_type'); ?></div>
					</td>
				</tr>

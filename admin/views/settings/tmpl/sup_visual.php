		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_TICKET_LABEL_WIDTH'); ?></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_subject_size'); ?></div>
					</td>
				</tr>	
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SUPPORT_SCEDITOR'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_TICKET_LINK_TARGET'); ?></div>
					</td>
				</tr>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_reply_width'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_reply_height'); ?></div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_ticket_per_page'); ?></div>
					</td>
				</tr>		
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('FOR_UNREGISTERED_TICKETS__HIGHLIGHT_THE_PASSWORD_INFORMATION_NEEDED_TO_ACCESS_THE_TICKET_'); ?></div>
					</td>
				</tr>			
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_sel_prod_dept'); ?></div>
					</td>
				</tr>					
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_open_show_error_alert'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_info_cols_user'); ?></div>
					</td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_admin_reply_width'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_admin_reply_height'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_show_msg_counts'); ?></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_messages_at_top'); ?></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_absolute_last_open'); ?></div>
					</td>
				</tr>			
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_insertpopup'); ?></div>
					</td>
				</tr>
					<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_entire_row'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SHOW_ALL_CLOSED_TAB'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SHOW_ALL_OPEN_TAB'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SHOW_ALL_TICKETS_TAB'); ?></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_info_cols'); ?></div>
					</td>
				</tr>	
			</table>
		</fieldset>

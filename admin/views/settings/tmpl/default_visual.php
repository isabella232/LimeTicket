...
?>
		<iframe class="iframe_load_wait" style="display: none;" id="csstest_component" src="<?php echo JURI::root(true).'/index.php?option=com_limeticket&view=csstest&type=test&tmpl=component'; ?>"></iframe>
		<iframe class="iframe_load_wait" style="display: none;" id="csstest_normal" src="<?php echo JURI::root(true).'/index.php?option=com_limeticket&view=csstest&type=test'; ?>"></iframe>

		<div id="css_alert" class="alert alert-<?php if (LIMETICKET_Settings::get('bootstrap_template') != LIMETICKET_Helper::GetTemplate()) {echo "danger";} else {echo "info";} ?>">
		...
		<div id="current_template" style="display: none;"><?php echo LIMETICKET_Helper::GetTemplate(); ?></div>
		<input name="bootstrap_template" id="bootstrap_template" type="hidden" value="<?php echo LIMETICKET_Settings::get('bootstrap_template'); ?>" />
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings" width="100%">	
				<tr>
					...
					<td style="width:250px;">
						<select name="bootstrap_css" id="bootstrap_css">
							...
							<option value="limeticketonly" <?php if ($this->settings['bootstrap_css'] == "limeticketonly") echo " SELECTED"; ?> ><?php echo JText::_('ONLY_FOR_FREESTYLE'); ?></option>
							<option value="limeticketonlyv3" <?php if ($this->settings['bootstrap_css'] == "limeticketonlyv3") echo " SELECTED"; ?> ><?php echo JText::_('ONLY_FOR_FREESTYLE_V3'); ?></option>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SET_HELP_BOOTSTRAP_JS'); ?></div>
					</td>
				</tr>
				<?php endif; ?>
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('THE_COLOR_YOUR_TEMPLATES_USES_FOR_TABLE_BORDERS'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SET_HELP_ARTISTEER_FIXES'); ?></div>
					</td>
				</tr>				<tr>
					<td colspan="3">
						<p>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SET_HELP_BOOTSTRAP_TEXTCOLOR'); ?></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SET_HELP_BOOTSTRAP_MODAL'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('INCLUDE_ICOMOON_ICONS_IN_STYLESHEET'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SET_HELP_bootstrap_v3'); ?></div>
					</td>
				</tr>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">		
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_skin_style'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_TITLE_PREFIX'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_BROWSER_PREFIX'); ?></div>
					</td>
				</tr>			<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_use_joomla_page_title_setting'); ?></div>
				</td>
				</tr>
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_faq_cat_prefix'); ?><div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_page_headingout'); ?><div>
					</td>
				</tr>		
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_bootstrap_pribtn'); ?><div>
					</td>
				</tr>		
			</table>
		</fieldset>
		<fieldset class="adminform">
			...
			<table class="admintable" width="100%">
				<tr>
					...
					<td>
						<div class="limeticket_help"><?php echo JText::_('TMPLHELP_display_style'); ?>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="limeticket_help"><?php echo JText::_('TMPLHELP_display_popup_style'); ?>
				...
				<tr>
					...
					<td>
						<div class="limeticket_help"><?php echo JText::_('TMPLHELP_display_module_style'); ?>
		...
		<fieldset class="adminform">
			...
			<table class="admintable" width="100%">
				<tr>
					...
					<td>
						<div class="limeticket_help"><?php echo JText::_('TMPLHELP_display_h1'); ?></div>
					</td>
				</tr>
				<tr>
					<td colspan="2" width="60%">	
					...
					<td>
						<div class="limeticket_help"><?php echo JText::_('TMPLHELP_display_h2'); ?></div>
					</td>
				</tr>
				<tr>
					<td colspan="2" width="60%">
						...
						<td>
						<div class="limeticket_help"><?php echo JText::_('TMPLHELP_display_h3'); ?></div>
					</td>
				</tr>
				<tr>
					<td colspan="2" width="60%">	
					...
					<td>
						<div class="limeticket_help"><?php echo JText::_('TMPLHELP_display_head'); ?>
				...
				<tr>
					...
					<td>
						<div class="limeticket_help"><?php echo JText::_('TMPLHELP_display_foot'); ?></div>
					</td>
				</tr>

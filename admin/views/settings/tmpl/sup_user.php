		...
		<fieldset class="adminform">
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_can_close'); ?></div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_can_reopen'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_can_change_status'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_show_close_reply'); ?></div>
					</td>
				</tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_restrict_prod_view'); ?></div>
					</td>
				</tr>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SUPPORT_SIMPLE_USERLIST_TABS'); ?></div>
					</td>
				</tr>			
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SUPPORT_SIMPLE_USERLIST_SEARCH'); ?></div>
					</td>
				</tr>			
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_HIDE_ON_TICKET_DETAILS'); ?></div>
					</td>
				</tr>	
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_show_reply_always'); ?></div>
					</td>
				</tr>	
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_reply_under'); ?></div>
					</td>
				</tr>	
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_reverse_messages'); ?></div>
					</td>
				</tr>	

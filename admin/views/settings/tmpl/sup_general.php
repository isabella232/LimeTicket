		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_hide_priority'); ?></div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_hide_handler'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_hide_category'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_hide_users_tickets'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_hide_tags'); ?></div>
					</td>
				</tr>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_custom_register'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_custom_lost_username'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_custom_lost_password'); ?></div>
					</td>
				</tr>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_user_attach'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_attach_max_size'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_attach_max_size_admins'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td colspan="2">
						<div>php.ini <code>upload_max_filesize</code> = <?php echo LIMETICKET_Helper::display_filesize(LIMETICKET_Helper::convertPHPSizeToBytes(ini_get('upload_max_filesize'))); ?></div>
						<div>php.ini <code>post_max_size</code> = <?php echo LIMETICKET_Helper::display_filesize(LIMETICKET_Helper::convertPHPSizeToBytes(ini_get('post_max_size'))); ?></div>
						<div><?php echo JText::_("support_attach_max_size"); ?> = <?php echo LIMETICKET_Helper::display_filesize(LIMETICKET_Helper::getMaximumFileUploadSize()); ?></div>
						<div><?php echo JText::_("support_attach_max_size_admins"); ?> = <?php echo LIMETICKET_Helper::display_filesize(LIMETICKET_Helper::getMaximumFileUploadSize(true)); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_attach_types'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_attach_types_admins'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">				
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SUPPORT_ATTACHMENT_FILENAME'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">				
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_attach_storage_filename'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_attach_use_old_system'); ?></div>
					</td>
				</tr>
			</table>
		</fieldset>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td rowspan="3">
						<div class='limeticket_help'>
						<?php echo JText::sprintf('CRON_AUTOCLOSE_MSG', JText::_('AUTOCLOSE_MIDDLE'), JURI::root() . 'index.php?option=com_limeticket&view=cron', JURI::root() . 'index.php?option=com_limeticket&view=cron'); ?><br />
						<a href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=cronlog'); ?>">
							<img style="float:none;margin:0px;" src='<?php echo JURI::base(); ?>/components/com_limeticket/assets/log.png'>
		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_ratings_per_message'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_ratings_per_message_change'); ?></div>
					</td>
				</tr>			
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_ratings_per_message_admin_overview'); ?></div>
					</td>
				</tr>			
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_ratings_ticket'); ?></div>
					</td>
				</tr>					
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_ratings_ticket_change'); ?></div>
					</td>
				</tr>			
			</table>
		</fieldset>

		...
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_rate'); ?></div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_comments'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_use_content_plugins'); ?></div>
					</td>
				</tr>
			</table>
		</fieldset>
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_views'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_view_top'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_recent'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_recent_stats'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_rated'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_rated_stats'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_viewed'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_viewed_stats'); ?></div>
					</td>
				</tr>
			</table>
		</fieldset>
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_dates'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_art_related'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_art_products'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_art_attach'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_show_art_attach_filenames'); ?></div>
					</td>
				</tr>				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_comments_per_page'); ?></div>
					</td>
				</tr>
			</table>
		</fieldset>
		<fieldset class="adminform">
			...
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_smaller_subcat_images'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_art_per_page'); ?></div>
					</td>
				</tr>	
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_prod_per_page'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_print'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_contents_auto'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_("THIS_ONLY_APPLIES_WHEN_A_PRODUCT_HAS_BEEN_SELECTED__IF_A_SINGLE_CATEGORY_IS_DISPLAYED_THEN_THE_SYSTEM_WILL_REDIRECT_THE_PAGE_TO_DISPLAY_THAT_CATEGORY_"); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_kb_popup_width'); ?></div>
					</td>
				</tr>
			</table>
		</fieldset>

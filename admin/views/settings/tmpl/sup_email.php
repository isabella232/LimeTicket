		...
		<fieldset class="adminform">
			<table class="table table-bordered table-condensed table-striped table-settings">
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_unassigned'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_admincc'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_from_address'); ?></div>
				</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_from_name'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_site_name'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="width:250px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_on_create'); ?></div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_handler_on_create'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_on_reply'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_handler_on_reply'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_handler_on_forward'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_handler_on_private'); ?></div>
					</td>
				</tr>				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_on_close'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key" style="padding-left: 8px;">					
							<img src='<?php echo JURI::root(); ?>administrator/components/com_limeticket/assets/images/arrow_indent.gif'>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_on_close_no_dropdown'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_all_admins'); ?></div>
					</td>
				</tr>			
				<tr>
					<td align="left" class="key" style="padding-left: 8px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_all_admins_only_unassigned'); ?></div>
					</td>
				</tr>			<tr>
					<td align="left" class="key" style="padding-left: 8px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_all_admins_ignore_auto'); ?></div>
					</td>
				</tr>			<tr>
					<td align="left" class="key" style="padding-left: 8px;">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_all_admins_can_view'); ?></div>
					</td>
				</tr>	
							<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_file_user'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_file_handler'); ?></div>
					</td>
				</tr>	
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_bcc_handler'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_send_empty_handler'); ?></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_include_autologin'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_include_autologin_handler'); ?></div>
					</td>
				</tr>
                <?php endif; ?>
                <tr>
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_link'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_link_unreg'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_link_reg'); ?></div>
					</td>
				</tr>
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_link_admin'); ?></div>
					</td>
				</tr>			
				<tr>
					<td align="left" class="key">	
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_support_email_link_pending'); ?></div>
					</td>
				</tr>	
				<tr>
					<td align="left" class="key">		
					...
					<td>
						<div class='limeticket_help'><?php echo JText::_('SETHELP_SUPPORT_EMAIL_NO_DOMAIN'); ?></div>
					</td>
				</tr>	
			</table>
		</fieldset>

...
class LimeticketsControllerTicketcat extends LimeticketsController
{
	...
	function save()
	{
		...
		if ($this->task == "apply")
		{
			$link = "index.php?option=com_limeticket&controller=ticketcat&task=edit&cid[]=" . $model->_id;
		} else if ($this->task == "save2new")
		{
			$link = 'index.php?option=com_limeticket&controller=ticketcat&task=edit';
		} else {
			$link = 'index.php?option=com_limeticket&view=ticketcats';
		}
		$this->setRedirect($link, $msg);
	}
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_limeticket&view=ticketcats', $msg );
	}

...
class LimeticketsControllerMainmenu extends LimeticketsController
{
	...
	function save()
	{
		...
		$link = 'index.php?option=com_limeticket&view=mainmenus';
		$this->setRedirect($link, $msg);
	}
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_limeticket&view=mainmenus', $msg );
	}
	...
	private function convert_items()
	{
		...
		{
			$qry = "UPDATE #__limeticket_main_menu SET title = 'MAIN_MENU_{$string}', description = 'MAIN_MENU_{$string}_DESC' WHERE itemtype = $type";
			//echo $qry."<br>";

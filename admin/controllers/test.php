...
class LimeticketsControllerTest extends LimeticketsController
{
	...
	function save()
	{
		...
		$link = 'index.php?option=com_limeticket&view=tests';
		$this->setRedirect($link, $msg);
	}
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_limeticket&view=tests', $msg );
	}

...
class limeticketsControllerticketemail extends JControllerLegacy
{
	...
	function save()
	{
		...
		if ($this->task == "apply")
		{
			$link = "index.php?option=com_limeticket&controller=ticketemail&task=edit&cid[]=" . $model->_id;
		} else if ($this->task == "save2new")
		{
			$link = 'index.php?option=com_limeticket&controller=ticketemail&task=edit';
		} else {
			$link = 'index.php?option=com_limeticket&view=ticketemails';
		}
	...
	function cancel()
	{
		...
		$this->setRedirect( 'index.php?option=com_limeticket&view=ticketemails', $msg );
	}

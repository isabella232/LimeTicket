...
class LimeticketsControllerTicket extends LimeticketsController
{
	...
	function save()
	{
		...
		$link = 'index.php?option=com_limeticket&view=tickets';
		$this->setRedirect($link, $msg);
	}
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_limeticket&view=ticket', $msg );
	}

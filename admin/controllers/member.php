...
class LimeticketsControllerMember extends LimeticketsController
{
	...
	function save()
	{
		...
		$link = 'index.php?option=com_limeticket&view=members&groupid=' . JRequest::getVar('groupid');
		$this->setRedirect($link, $msg);
	}
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_limeticket&view=members&groupid=' . JRequest::getVar('groupid'), $msg );
	}

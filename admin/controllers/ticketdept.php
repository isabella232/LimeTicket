...
class LimeticketsControllerTicketdept extends LimeticketsController
{
	...
	function save()
	{
		...
		if ($this->task == "apply")
		{
			$link = "index.php?option=com_limeticket&controller=ticketdept&task=edit&cid[]=" . $model->_id;
		} else if ($this->task == "save2new")
		{
			$link = 'index.php?option=com_limeticket&controller=ticketdept&task=edit';
		} else {
			$link = 'index.php?option=com_limeticket&view=ticketdepts';
		}
		$this->setRedirect($link, $msg);
	}
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_limeticket&view=ticketdepts', $msg );
	}

...
class LimeticketsControllerField extends LimeticketsController
{
	...
	function save()
	{
		...
		if ($this->task == "apply")
		{
			$link = "index.php?option=com_limeticket&controller=field&task=edit&cid[]=" . $model->_id;
		} else if ($this->task == "save2new")
		{
			$link = 'index.php?option=com_limeticket&controller=field&task=edit';
		} else {
			$link = 'index.php?option=com_limeticket&view=fields';
		}
		$this->setRedirect($link, $msg);
	}
	...
	function unpublish()
	{
		...
		$this->setRedirect( 'index.php?option=com_limeticket&view=fields', $msg );
	}

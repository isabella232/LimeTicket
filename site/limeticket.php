...
if (version_compare(phpversion(), '5.3.0', '<')) {
	...
	$menu = $app->getMenu();
	if ($menu->getActive() == $menu->getDefault() && !LIMETICKET_Settings::get('hide_warnings') && JRequest::getVar('view') != 'cron') {
		echo "<div class='alert alert-danger'><h4>Freestyle Support cannot be run as your default menu item,</h4><p>LimeTicket Support Portal ";
	...
	if($controller = LIMETICKET_Input::getCmd('controller')) {
	...
	if ($view != "csstest") LIMETICKET_Helper::StylesAndJS(array('tooltip'));

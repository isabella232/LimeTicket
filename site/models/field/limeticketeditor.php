...
class JFormFieldLIMETICKETEditor extends JFormFieldEditor
{
	...
	public function getInput()
	{
		if ($this->element['code'])
		{
			...
			$document->addScript(JURI::root().'administrator/components/com_limeticket/assets/js/codemirror/init.js'); 
			...
			$document->addScript(JURI::root().'administrator/components/com_limeticket/assets/js/codemirror/modes/php/php.js'); 
			$document->addScript(JURI::root().'administrator/components/com_limeticket/assets/js/codemirror/modes/htmlmixed/htmlmixed.js'); 
			$document->addScript(JURI::root().'administrator/components/com_limeticket/assets/js/codemirror/modes/sql/sql.js'); 
			$document->addScript(JURI::root().'administrator/components/com_limeticket/assets/js/codemirror/modes/clike/clike.js'); 
			$document->addScript(JURI::root().'administrator/components/com_limeticket/assets/js/codemirror/modes/smarty/smarty.js'); 
			$document->addScript(JURI::root().'administrator/components/com_limeticket/assets/js/codemirror/modes/smartymixed/smartymixed.js'); 
	...
	function CodeInput()
	{
		$class = ' class="limeticket_codemirror_editor html" ';

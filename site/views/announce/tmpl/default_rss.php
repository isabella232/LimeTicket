...
<?php foreach($this->announces as $announce): ?>
		...
		<link><?php echo $baseUrl; ?><?php echo htmlentities(LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=announce&announceid=' . $announce['id'] )); ?></link>
		<guid><?php echo $baseUrl; ?><?php echo htmlentities(LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=announce&announceid=' . $announce['id'] )); ?></guid>

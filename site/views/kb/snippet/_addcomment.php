...
*     
* This file is part of LimeTicket Support Portal
...
<script type="text/javascript">
 var RecaptchaOptions = {
    theme : '<?php echo LIMETICKET_Settings::get('recaptcha_theme'); ?>'
 };
</script>

<div class='limeticket_kb_comment_add' id='add_comment'>
<?php if (LIMETICKET_Settings::get('kb_hide_add')): ?>
	<a id="commentaddbutton" href='#' onclick='$("commentadd").style.display="block";$("commentaddbutton").style.display="none";return false;' class='limeticket_kb_comment_add_text'><?php echo JText::_("ADD_A_COMMENT"); ?></a>
	<div id="commentadd" style="display:none;">
<?php endif; ?>
	<div class='limeticket_kb_comment_add_text'><?php echo JText::_("ADD_A_COMMENT"); ?></div>
	...
	<tr>
			<th><?php echo JText::_("VERIFICATION"); ?> <?php if ($this->valid == -1) :?><div class='limeticket_invalid_captcha'><?php echo JText::_("INVALID_CODE"); ?></div><?php endif; ?></th>

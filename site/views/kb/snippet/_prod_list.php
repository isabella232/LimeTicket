...
?>
<div class='limeticket_kb_prodlist'>
...
function SetupProdSearch()
{
	jQuery('#prod_submit').click( function(ev){
		...
		url = limeticket_url_append(url, 'tmpl', 'component');
		url = limeticket_url_append(url, 'prodsearch', value);
		url = limeticket_url_append(url, 'limit', limit);
	...
	jQuery('#prod_reset').click( function(ev){
		...
		var url = jQuery('#searchProd').attr('action');
		url = limeticket_url_append(url, 'tmpl', 'component');
		url = limeticket_url_append(url, 'prodsearch', '__all__');
...
function ChangePage(newpage)
{
	...
	
	{
		...
		url = limeticket_url_append(url, 'prodsearch', value);
		url = limeticket_url_append(url, 'limit', limit);
		url = limeticket_url_append(url, 'limitstart', limitstart);

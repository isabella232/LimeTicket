...
<?php echo LIMETICKET_Helper::PageTitle("KNOWLEDGE_BASE","SEARCH_RESULTS"); ?>
...
<div class="limeticket_kb_search">
		<form id="searchProd" action="<?php echo LIMETICKETRoute::_( '&view=kb' );// FIX LINK?>" method="post" name="limeticketForm">
		<?php if ($product['id'] > 0): ?>
		...
		<div class="input-append">	
			<input id='kb_search' type='text' name='kbsearch' value="<?php echo LIMETICKET_Helper::escape($this->search); ?>" placeholder='<?php echo $title; ?>'>
...
<?php if (count($this->results) == 0): ?>
	...
	<p class="limeticket_no_results"><?php echo JText::_("NO_ARTICLES_MATCH_YOUR_SEARCH_CRITERIA"); ?></p>

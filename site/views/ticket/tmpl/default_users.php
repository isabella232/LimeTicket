...
<?php echo LIMETICKET_Helper::PageTitle("INCLUDE_USER"); ?>
<div><?php echo JText::_('INCLUDE_USER_HELP'); ?></div>
<form action="<?php echo JRoute::_( 'index.php?option=com_limeticket&view=ticket&tmpl=component&what=addccuser&ticketid=' . JRequest::getVar('ticketid') );?>" method="post" name="limeticketForm">
<div id="editcell">
	<table>
		<tr>
			<td width="100%">
				<?php echo JText::_("SEARCH"); ?>:
				<input type="text" name="search" id="search" value="<?php echo JView::escape($this->search);?>" onchange="document.limeticketForm.submit();"/><br>
    ...
    <table class="limeticket_table" cellpadding="0" cellspacing="0" width="100%">
    <thead>
    ...
    {
        //$link = JRoute::_( 'index.php?option=com_limeticket&controller=faq&task=edit&cid[]='. $row->id );

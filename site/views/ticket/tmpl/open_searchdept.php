	...
	<?php if (!$has_cats): ?>
		<ul class="unstyled departments">
			<?php foreach ($this->depts as $dept): ?>
				<?php include $this->snippet(JPATH_SITE.DS.'components'.DS.'com_limeticket'.DS.'views'.DS.'ticket'.DS.'snippet'.DS.'_dept.php'); ?>
			<?php endforeach; ?>
		</ul>
		...
		<?php foreach ($this->depts as $dept): ?>
			...
			<?php if ($dept->category != $category): ?>
				...
				<?php else: ?>
					...
					<div class="department_category_indent <?php if (LIMETICKET_Settings::get('support_open_accord')) echo 'collapse' ?>" id="prodcat<?php echo $cid++; ?>">
				<?php endif; ?>
			...
			<?php if ($dept->subcat != $subcat): ?>
				...
				<?php else: ?>
					...
					<div class="department_subcat_indent <?php if (LIMETICKET_Settings::get('support_open_accord')) echo 'collapse' ?>" id="prodcat<?php echo $cid++; ?>">
				<?php endif; ?>

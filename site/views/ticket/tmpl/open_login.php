...
<?php LIMETICKET_Helper::HelpText("support_open_login_header"); ?>
...
<?php if (LIMETICKET_Settings::get('support_allow_unreg') == 1): ?>
	<?php echo LIMETICKET_Helper::PageSubTitle("CREATE_WITHOUT_ACCOUNT"); ?>
	...
	<form action="<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=ticket&layout=open&what=without"); ?>"  method="post" name="uregform" id="uregform" class="form-horizontal form-condensed">

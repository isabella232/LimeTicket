...
?>
	...
	<div class="media faq_cat faq_cat_<?php echo $cat['id']; ?>">
		...
		<a class="pull-left" href="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=faq&catid=' . $cat['id']);?>"
			...
			<?php if ($cat['image']) : ?>
	    			...
	    			<img class="media-object" src='<?php echo JURI::root( true ); ?><?php echo LIMETICKET_Helper::escape($cat['image']); ?>' width='64' height='64'>
	    		<?php else: ?>
	    			<img class="media-object" src='<?php echo JURI::root( true ); ?>/images/limeticket/faqcats/<?php echo LIMETICKET_Helper::escape($cat['image']); ?>' width='64' height='64'>
	    		<?php endif; ?>
			<?php endif; ?>
		</a>
				...
				<div
					...
					<h4 class="media-heading">
						<?php if ($this->view_mode_cat == "popup") : ?>
							...
							<a class="show_modal_iframe" href='<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=faq&tmpl=component&catid=' . $cat['id'] . '&view_mode=' . $this->view_mode_incat); ?>'>
								<?php echo $cat['title'] ?>
							</a>

						<?php elseif ($this->view_mode_cat == "accordian"): ?>

							<a href="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=faq&catid=' . $cat['id']);?>" onclick='return false;'><?php echo $cat['title'] ?></a>
						
						<?php else: ?>

							<a href='<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=faq&catid=' . $cat['id']);?>'><?php echo $cat['title'] ?></a>

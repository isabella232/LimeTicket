...
<?php $text = $faq['answer']; 
	if ($faq['fullanswer'])
		$text .= "<div class='limeticket_faq_more'><a href='#'>click for more...</a></div>";
				
	$output = str_replace("'", "", $text);
	if (array_key_exists($faq['id'], $this->tags))
	{
		$output .= '<div class="limeticket_faq_tags">';
...
<div class="media faq_faq faq_<?php echo $cat['id'] . "_" . $faq['id']; ?>_cont faq_<?php echo $faq['id']; ?>_cont"">
	...
	<div class="media-body">
		<h5 class="media-heading">
			<a href='<?php echo LIMETICKETRoute::_( '&faqid=' . $faq['id'] );// FIX LINK ?>' 
				class='limeticketTip' 

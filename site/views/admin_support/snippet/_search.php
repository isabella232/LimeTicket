...
$default = "basic";
if (LIMETICKET_Settings::get('support_advanced_default'))
	$default = "advanced";

$searchtype = LIMETICKET_Input::getCmd('searchtype',$default);

if (LIMETICKET_Input::getInt('showbasic') == 1)
	$searchtype = "basic";
...
<?php if (LIMETICKET_Input::getInt('showbasic') == 1): ?>
<input type="hidden" id="showbasic" name="showbasic" value="1">	
<?php endif; ?>

<input type="hidden" id="searchtype" name="searchtype" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getCmd('searchtype',$default)); ?>">
<input type="hidden" name="what" id="limeticket_what" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getCmd('what','')); ?>">
...
<div class="pull-right btn-group">
	...
	<ul class="dropdown-menu">
		...
		<li class="divider"></li>
		<li>
			<a href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=emails'); ?>">
				<?php echo JText::_("EMAIL_IMPORTS"); ?>
			</a>
		</li>			
		<li class="divider"></li>
		<li>
			<a href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=settings'); ?>">
				<?php echo JText::_("MY_SETTINGS"); ?>
			</a>
		</li>		
		<li>
			<a class="show_modal_iframe" href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=signature&tmpl=component'); ?>">
				<?php echo JText::_("SIGNATURES"); ?>
			</a>
		</li>
		<li>
			<a class="show_modal_iframe" href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=canned&tmpl=component'); ?>">
				<?php echo JText::_("CANNED_REPLIES"); ?>
			</a>
		</li>	
		<li>
			<a href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=outofoffice'); ?>">
				<?php echo JText::_("OUT_OF_OFFICE"); ?>
			</a>
		</li>
		<li>
			<a href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=listhandlers'); ?>">
				<?php echo JText::_("LIST_HANDLERS"); ?>
			</a>
		</li>

		<?php echo LIMETICKET_GUIPlugins::output("adminTicketListTools"); ?>
	</ul>
</div>

<div class="form-horizontal form-condensed">

	<?php if (!LIMETICKET_Settings::get('support_no_admin_for_user_open')): ?>
 	<div class="control-group">
		<label class="control-label"><?php echo JText::_("CREATE_TICKET_FOR"); ?></label>
		<div class="controls">
			<a class="btn btn-default" href="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=admin_support&layout=new&type=registered' ); ?>"><?php echo JText::_("REGISTERED_USER"); ?></a>
			<?php if (LIMETICKET_settings::get('support_allow_unreg')): ?>
				<a class="btn btn-default" href="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=admin_support&layout=new&type=unregistered' ); ?>"><?php echo JText::_("UNREGISTERED_USER"); ?></a>	
			<?php endif; ?>
	...
	<div class="control-group" id="basicsearch" style="<?php echo $basicstyle ?>">
		...
		<div class="controls">
			<div class="input-append">
				<input type="text" name="search" class='input-medium' id="basic_search" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('search','')); ?>">
				<input class='btn btn-primary' type="submit" onclick="jQuery('#searchtype').val('basic');limeticket_submit_search();" value="<?php echo JText::_("SEARCH") ?>">
...
?>
	...
	<?php NextField(); ?>
			...
			<td><input type="text" name="subject" id="advanced_subject" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('subject','')); ?>"></td>
			<?php AddAdvancedReset("advanced_subject"); ?>
			
	<?php NextField(); ?>
			<td><?php echo JText::_("TICKET_REF") ?>:</td>
			<td><input type="text" name="reference" id="advanced_ref" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('reference','')); ?>"></td>
	...
	<?php NextField(); ?>
			...
			<td>
				<div id="user_select" class="btn-group">
					<input type="text" name="username" id="advanced_username" autocomplete="off" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('username','')); ?>">
	...
	<?php NextField(); ?>
			...
			<td><input type="text" name="useremail" id="advanced_email" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('useremail','')); ?>"></td>
			<?php AddAdvancedReset("advanced_email"); ?>
			
	<?php NextField(); ?>
			<td><?php echo JText::_("NAME") ?>:</td>
			<td><input type="text" name="userfullname" id="advanced_name" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('userfullname','')); ?>"></td>
	...
	<?php NextField(); ?>
			...
			<select name="handler[]" id="advanced_handler" class="select-color" multiple="true" data-placeholder="<?php echo htmlspecialchars(JText::_("ALL_HANDLERS")); ?>">
					<?php $handlerids = LIMETICKET_Input::getIntArray('handler',''); ?>
	...
	<?php NextField(); ?>
			...
			<td><input type="text" name="content" id="advanced_message" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('content','')); ?>"></td>
			<?php AddAdvancedReset("advanced_message"); ?>
			
	<?php NextField(); ?>
			<td><?php echo JText::_("STATUS") ?>:</td>
			<td>
				<?php $statusids = LIMETICKET_Input::getCmdArray('status'); ?>
				<select name="status[]" id="advanced_status" multiple="true" class="select-color" data-placeholder="<?php echo htmlspecialchars(JText::_("ALL_STATUSES")); ?>">
					<optgroup label="<?php echo JText::_('STATUSS'); ?>">
						<?php foreach ($this->statuss as $status) :?>
							<option value="<?php echo $status->id ?>" <?php if (in_array($status->id, $statusids)) echo " SELECTED "; ?> style='color: <?php echo LIMETICKET_Helper::escape($status->color); ?>'><?php echo $status->title ?></option>
						<?php endforeach; ?>
					</optgroup>
	...
	<?php NextField(); ?>
			...
			<td>
			<?php $products = LIMETICKET_Input::getIntArray('product'); ?>
	...
	<?php NextField(); ?>
			...
			<td>
			<?php $departmentids = LIMETICKET_Input::getIntArray('department'); ?>
	...
	<?php if (count($this->categories) > 0 && LIMETICKET_Settings::get('support_hide_category') != 1): ?>
	<?php NextField(); ?>
			<td><?php echo JText::_("CATEGORY") ?>:</td>
			<td>
				<?php $catids = LIMETICKET_Input::getIntArray('cat'); ?>
	...
	<?php NextField(); ?>
			...
			<td>
			<?php $priorityids = LIMETICKET_Input::getIntArray('priority'); ?>
	...
	<?php NextField(); ?>
			...
			<td>
			<?php $groupids = LIMETICKET_Input::getIntArray('group'); ?>
	...
	<?php endif; ?>
	<?php
	$customfields = LIMETICKETCF::GetAllCustomFields(true);
	...
	<?php NextField(); ?>
			...
			<?php if ($field['type'] == "area" || $field['type'] == "text") : ?>
					<input type="text" name="custom_<?php echo $field['id']; ?>" id="advanced_custom_<?php echo (int)$field['id']; ?>" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('custom_'.$field['id'],'')); ?>">
				<?php elseif ($field['type'] == "checkbox") : ?>
					<select name="custom_<?php echo $field['id']; ?>" id="advanced_custom_<?php echo (int)$field['id']; ?>">
						...
						<option value="1" <?php if (LIMETICKET_Input::getString('custom_'.$field['id'],'') == "1") echo "SELECTED"; ?> ><?php echo JText::_("YES") ?></option>		
						<option value="0" <?php if (LIMETICKET_Input::getString('custom_'.$field['id'],'') == "0") echo "SELECTED"; ?> ><?php echo JText::_("NO") ?></option>		
					</select>			
				<?php elseif ($field['type'] == "radio" || $field['type'] == "combo") : ?>
					<select name="custom_<?php echo $field['id']; ?>" id="advanced_custom_<?php echo $field['id']; ?>">
						...
						<?php foreach($field['values'] as $value): ?>
							...
							<option value="<?php echo LIMETICKET_Helper::escape($value); ?>" <?php if (LIMETICKET_Input::getString('custom_'.$field['id'],'') == $value) echo "SELECTED"; ?> ><?php echo $value; ?></option>
						<?php endforeach; ?>	
					</select>
				<?php else: ?>
					<?php 
	...
	<?php NextField(); ?>
			...
			<td>
				<input type="text" name="date_from" id="advanced_date_from" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('date_from','')); ?>" size="12">
			</td>
	<?php NextField(); ?>
			<?php AddAdvancedReset("advanced_date_to"); ?>
			<td><?php echo JText::_("DATE_TO") ?>:</td>
			<td>
				<input type="text" name="date_to" id="advanced_date_to" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('date_to','')); ?>"  size="12">
			</td>
	...
	<div class="control-group advsearch" style="<?php echo $advancedstyle ?>">
		...
		<div class="controls">
			<div class="btn-group">
				<input class='btn btn-primary' type="submit" onclick="jQuery('#searchtype').val('advanced');limeticket_submit_search();" value="<?php echo JText::_("SEARCH") ?>">
...
<?php if (!LIMETICKET_Settings::get('support_hide_tags')) : ?>
	...
	<div class="control-group">
		...
		<div class="controls">
				...
				<a class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#">
					...
					<?php if ($this->taglist && count($this->taglist) > 0): ?>
						<?php foreach ($this->taglist as $tag): ?>
							<li>
								<a href='#' onclick="tag_add('<?php echo LIMETICKET_Helper::escape($tag->tag); ?>');return false;"><?php echo $tag->tag; ?></a>
							</li>
						<?php endforeach; ?>
					<?php else: ?>
			...
			<input name="tags" id="tags" type="hidden" value="<?php echo LIMETICKET_Helper::escape(LIMETICKET_Input::getString('tags','')); ?>">
		</div>
	</div>
...
function limeticket_submit_search()
{
	...
	jQuery('#limeticket_what').val('search');
...
<div id="users_search_url" style="display: none;"><?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=admin_support&task=users.search", false); ?></div>

	...
	<div class="alert alert-warning">
		...
		<ul>
			<?php foreach ($this->merged as $mt): ?>
				<li>
					<a href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=ticket&ticketid=' . $mt->id . "&no_redirect=1&Itemid=" . LIMETICKET_Input::getInt('Itemid'), false); ?>">
	...
	<div class="alert alert-error">
		...
		<ul>
			...
			if ($ticket_m->load($this->ticket->merged)) : ?>
				<li>
					<a href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=ticket&ticketid=' . $ticket_m->id . "&Itemid=" . LIMETICKET_Input::getInt('Itemid'), false); ?>">

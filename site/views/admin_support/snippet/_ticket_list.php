...
<?php
$curstatus = LIMETICKET_Input::getCmd('tickets');
if ($curstatus == -1)
	$curstatus = LIMETICKET_Input::getCmd('status');
?>

<div id="batch_form" class="form-horizontal form-condensed" style='display: none'>

<div class="batch_print_hide">
	<?php echo LIMETICKET_Helper::PageSubTitle("BATCH_ACTIONS"); ?>
</div>
<div class="batch_action_hide">
	<?php echo LIMETICKET_Helper::PageSubTitle("BATCH_PRINT"); ?>
</div>
...
<div class="control-group">
		...
		<div class="controls">
			<div class="btn-group">
				...
				<button class="btn btn-default" id="batch_select_none"><?php echo JText::_('LIMETICKET_NONE'); ?></button>
		...
		<div class="controls">
			...
			<div class="btn-group batch_action_hide">
				...
				<ul class="dropdown-menu">
					<li>
						<a href='<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=multiprint&print=all&tmpl=component'); ?>' target='_new' onclick='batch_print(this);'>
							<?php echo JText::_('ALL_DETAILS'); ?>
						</a>
					</li>
					<li>
						<a href='<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=multiprint&print=clean&tmpl=component'); ?>' target='_new' onclick='batch_print(this);'>
					...
					<li>
						<a href='<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=multiprint&print=' . $name . '&tmpl=component'); ?>' target='_new' onclick='batch_print(this);'>
...
<?php if (!empty($this->show_key) && $this->show_key): ?>
	<div class='ticket_key'>
		...
		<div class="btn-group limeticketTip" title="<?php echo JText::_('VIEW_MY_TICKETS'); ?>" style="display: inline-block;">
			...
			<ul class="dropdown-menu">
				<li>
					<a href='<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&tickets=-1&what=search&searchtype=advanced&showbasic=1&handler=-1&status=' . $curstatus); ?>'><?php echo JText::_('MY_TICKETS'); ?></a>
				</li>
				<li>
					<a href='<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&tickets=-1&what=search&searchtype=advanced&showbasic=1&handler=-4&status=' . $curstatus); ?>'><?php echo JText::_('MY_CC_TICKETS'); ?></a>
				</li>
				<li>
					<a href='<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&tickets=-1&what=search&searchtype=advanced&showbasic=1&handler=-5&status=' . $curstatus); ?>'><?php echo JText::_('MY_ASSIGNED_TICKETS'); ?></a>
				</li>
			</ul>
		</div>
		&nbsp;
		<div class="btn-group limeticketTip" title="<?php echo JText::_('VIEW_OTHER_HANDLERS_TICKETS'); ?>" style="display: inline-block;">
			<a href='<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&tickets=-1&what=search&searchtype=advanced&showbasic=1&handler=-2&status=' . $curstatus); ?>'><span class="label label-info" style="cursor: pointer"><?php echo JText::_('OTHER_HANDLERS_TICKETS'); ?></span></a>
		</div>
		&nbsp;
		<div class="btn-group limeticketTip" title="<?php echo JText::_('VIEW_UNASSIGNED_TICKETS'); ?>" style="display: inline-block;">
			<a href='<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&tickets=-1&what=search&searchtype=advanced&showbasic=1&handler=-3&status=' . $curstatus); ?>'><span class="label label-warning" style="cursor: pointer"><?php echo JText::_('UNASSIGNED'); ?></span></a>
		</div>
	</div>
<?php endif; ?>

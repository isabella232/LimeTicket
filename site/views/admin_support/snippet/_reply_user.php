...
<div class="control-group">
	...
	<div class="controls">
		<a class="btn btn-default show_modal_iframe" data_modal_width="800" href="<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=admin_support&layout=users&tmpl=component"); ?>"><?php echo JText::_("CHANGE"); ?></a>

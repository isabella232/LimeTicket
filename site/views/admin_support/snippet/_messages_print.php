...
<?php foreach ($this->messages as $message) : ?>
	<?php if ($message['admin'] == 3) : ?>
		<tr class="limeticket_support_msg_audit success" style="display:none;">
			<td>
				...
				<div class="pull-right" style="margin-left: 8px;">
					<i>
						<?php echo LIMETICKET_Helper::Date($message['posted'], LIMETICKET_DATETIME_MID); ?>
					</i>
				</div>
				...
				<?php if (array_key_exists("attach", $message)) : ?>
					<?php foreach ($message['attach'] as &$attach): ?>
						<div class="padding-mini">
							<a href='<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=ticket&fileid=' . $attach['id'] ); ?>'>
								<img src='<?php echo JURI::root( true ); ?>/components/com_limeticket/assets/images/download-16x16.png'>

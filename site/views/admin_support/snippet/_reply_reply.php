...
?>
	<div class="control-group">
		...
		<div class="controls">
			<select name="reply_status" class="select-color">
				...
				$def_admin = LIMETICKET_Ticket_Helper::GetStatusID('def_admin');
				if ($def_admin < 1)
	...
	(LIMETICKET_Settings::get('support_autoassign') == 3 && $this->ticket->admin_id == 0)) : ?>
		<div class="control-group">
	...
	<p>
		<textarea style='width:95%;height:<?php echo (int)((LIMETICKET_Settings::get('support_admin_reply_height') * 15) + 80); ?>px' name='body' id='body' class="sceditor" rows='<?php echo (int)LIMETICKET_Settings::get('support_admin_reply_height'); ?>' cols='<?php echo (int)LIMETICKET_Settings::get('support_admin_reply_width'); ?>'><?php echo htmlspecialchars($this->user_message); ?></textarea>
	</p>
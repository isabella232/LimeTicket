...
<form id='limeticketForm' action="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=admin_support&layout=settings' );?>" name="limeticketForm" method="post">
...
<div class="pull-right">
	...
	<a href="#" id='limeticket_form_save' class="btn btn-default"><i class="icon-save"></i> <?php echo JText::_('SAVE_AND_CLOSE');?></a> 
	<a href="#" id='limeticket_form_cancel' class="btn btn-default"><i class="icon-cancel"></i> <?php echo JText::_('CANCEL');?></a> 
</div>
		
<?php echo  LIMETICKET_Helper::PageSubTitle("MY_SETTINGS"); ?>
...
<div class="form-horizontal form-condensed">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" class="input-mini" name='per_page' value='<?php echo LIMETICKET_Helper::escape(SupportUsers::getSetting('per_page')); ?>' size="5">
...
{
	jQuery('#limeticketForm').find('input[name="action"]').val(task);

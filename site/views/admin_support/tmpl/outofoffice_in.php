...
<?php echo LIMETICKET_Helper::PageTitle('SUPPORT_ADMIN',"OUT_OF_OFFICE"); ?>
...
<form id="out_form" name="out_form" action="<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=admin_support&layout=outofoffice&task=outofoffice.out"); ?>" method="post" class="form-horizontal form-condensed">
	...
	<div class="control-group" id="button_panel">
		<div class="controls">
			...
			<a href="<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=admin_support&layout=listhandlers", false); ?>" class='btn btn-default'><?php echo JText::_('CANCEL'); ?></a>
		</div>
	</div>	
	...
	<div class="hide" id="ooo_form">
		...
		<div class="control-group" id="cg_message">
			...
			<div class="controls">
				<textarea style='width:95%;height:<?php echo (int)((LIMETICKET_Settings::get('support_admin_reply_height') * 15) + 80); ?>px' name='body' id='body' rows='<?php echo (int)LIMETICKET_Settings::get('support_admin_reply_height'); ?>' cols='<?php echo (int)LIMETICKET_Settings::get('support_admin_reply_width'); ?>'></textarea>
			</div>
		</div>
		<div class="control-group">
			<div class="controls">
...
<div id="ooo_tickets">
	<?php echo LIMETICKET_Helper::PageSubTitle('CURRENT_TICKETS'); ?>
...
jQuery(document).ready(function () {
	...
	jQuery('#assign').change(function () {
		limeticket_sort_View();
	});
	
	limeticket_sort_View();
});

function limeticket_sort_View()
{

...
?>
	...
	<?php echo LIMETICKET_Helper::PageTitlePopup("CREATE_NEW_USER"); ?>

	<form action="<?php echo LIMETICKETRoute::_( 'index.php?option=com_limeticket&view=admin_support&layout=createuser&tmpl=component', false );?>" method="post" name="limeticketForm" id="limeticketForm" class="form-horizontal form-condensed">
			...
			<div class="control-group <?php if ($this->errors['name']) echo "error"; ?>">
				...
				<div class="controls">
					<input type="text" name="name" value="<?php echo LIMETICKET_Helper::escape($this->data->name); ?>" required />
				</div>
			</div>
			...
			<div class="control-group <?php if ($this->errors['username']) echo "error"; ?>">
				...
				<div class="controls">
					<input type="text" name="username" value="<?php echo LIMETICKET_Helper::escape($this->data->username); ?>" required  />
				</div>
			</div>
			...
			<div class="control-group <?php if ($this->errors['password']) echo "error"; ?>">
				...
				<div class="controls">
					<input type="text" name="password" id="password" value="<?php echo LIMETICKET_Helper::escape($this->data->password); ?>" required  />
			...
			<div class="control-group <?php if ($this->errors['password2']) echo "error"; ?>">
				...
				<div class="controls">
					<input type="text" name="password2" id="password2" value="<?php echo LIMETICKET_Helper::escape($this->data->password2); ?>" required  />
				</div>
			</div>
			...
			<div class="control-group <?php if ($this->errors['email']) echo "error"; ?>">
				...
				<div class="controls">
					<input type="text" name="email" value="<?php echo LIMETICKET_Helper::escape($this->data->email); ?>" required  />
				</div>
			</div>
...
<div class="modal-footer">
	<a href="#" class='btn btn-success' onclick='jQuery("#limeticketForm").submit(); return false;'><?php echo JText::_("CREATE_NEW_USER"); ?></a>

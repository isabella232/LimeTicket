...
<div class="limeticket_main">
	<form id="mainform" action="<?php echo JRoute::_("index.php"); ?>" method="post" class="form-horizontal form-condensed">
		...
		<?php echo LIMETICKET_Helper::PageTitlePopup('SUPPORT_ADMIN',$this->sig_item->id > 0 ? "EDIT_SIGNATURE" : "NEW_SIGNATURE"); ?>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="description" value="<?php echo LIMETICKET_Helper::escape($this->sig_item->description); ?>" />
				</div>
			</div>
			<div class="control-group">
			...
			<p>
				<textarea style='width:97%; height:270px;' name='content' id='content' class="sceditor" rows='7' cols='40'><?php echo LIMETICKET_Helper::escape($this->sig_item->content); ?></textarea>
			</p>
		...
		<div class="modal-footer">
			...
			<a class="btn btn-default" href="<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=admin_support&tmpl=component&layout=signature" ); ?>"><?php echo JText::_('CANCEL'); ?></a>
		</div>
	</form>
</div>
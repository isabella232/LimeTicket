...
<?php echo LIMETICKET_Helper::PageTitle('SUPPORT_ADMIN',"EMAILS_AWAITING_APPROVAL"); ?>
	...
	<form method="post" action="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=emails'); ?>" name='limeticketForm' id='limeticketForm'>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-append">
						<select name="state" class="select-color" onchange="jQuery('#limeticketForm').submit();">
					...
					<?php foreach ($this->pending as $ticket): ?>
						<tr class="first" id="ticket_<?php echo $ticket->id; ?>">
							<td style="vertical-align:middle;word-break: break-all;">
								...
								<a class="show_modal_iframe" data_modal_width="760" href="<?php echo LIMETICKETRoute::_('index.php?option=com_limeticket&view=admin_support&layout=emails&tmpl=component&preview=' . $ticket->id); ?>">
							...
							<td style="vertical-align:middle;text-align:center;word-break: break-all;" nowrap>
								<?php echo LIMETICKET_Helper::Date($ticket->opened, LIMETICKET_DATE_SHORT); ?><br />
								<span class="small"><?php echo LIMETICKET_Helper::Date($ticket->opened, LIMETICKET_TIME_SHORT); ?></span>
							</td>
							...
							<td style="vertical-align:middle;text-align:center;" nowrap class="action_buttons">
								<?php if ($this->state == ""): ?>
									...
									<a href="<?php echo LIMETICKETRoute::_("index.php?option=com_limeticket&view=admin_support&layout=ticket&ticketid=" . $ticket->id,false); ?>" class="btn btn-info view_button" style="display: none;"><?php echo JText::_('VIEW'); ?></a>
								<?php else: ?>
...
function email_accept(ticketid)
{
	...
	var url = '<?php echo JRoute::_( 'index.php?option=com_limeticket&view=admin_support&task=emails.approve', false); ?>' + '&ticketid=' + ticketid;
...
function email_decline(ticketid)
{
	...
	var url = '<?php echo JRoute::_( 'index.php?option=com_limeticket&view=admin_support&task=emails.decline', false); ?>' + '&ticketid=' + ticketid;
...
function email_delete(ticketid)
{
	...
	var url = '<?php echo JRoute::_( 'index.php?option=com_limeticket&view=admin_support&task=emails.delete', false); ?>' + '&ticketid=' + ticketid;

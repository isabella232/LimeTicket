...
class FssViewAdmin_Support_OutOfOffice extends FssViewAdmin_Support
{
	function display($tpl = NULL)
	{
		...
		$this->userid = LIMETICKET_Input::getInt('user_id', $this->current_userid);		
		if (!LIMETICKET_Permission::auth("limeticket.ticket_admin.ooo", "com_limeticket.support_admin", JFactory::getUser()->id))

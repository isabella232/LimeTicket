...
?>
<?php if (!LIMETICKETJ3Helper::IsJ3() || LIMETICKET_Settings::get('support_attach_use_old_system')): ?>
...
<?php for ($i = 1; $i < 10 ; $i++): ?>
	...
	<div id="file_<?php echo $i; ?>" <?php if ($i > 1): ?> style='display:none;' <?php endif; ?>>
		...
		<a 
			...
			style='display: none' 
			onclick="limeticket_ClearFileInput(jQuery('#filedata_<?php echo $i; ?>')[0])"
			>&times;</a>
	</div>
...
<?php LIMETICKET_Helper::IncludeFileUpload(); ?>

...
<?php echo LIMETICKET_Helper::PageSubTitle2("USER_COMMENTS"); ?>
<?php endif; ?>

<?php if ($this->opt_show_add): ?>
<div class='limeticket_comment_add' id='add_comment'>
...
<div id="comments" class="limeticket_comments_result_<?php echo $this->uid; ?>">
<?php $offset = 0; ?>
<?php $page = LIMETICKET_Input::getInt('comm_page', 1); ?>
...
if ($pages > 1)
{
	...
	for ($i = 1 ; $i <= $pages ; $i++)
	{
		if ($i == $page)
		{
			...
			echo "<li><a href='" . LIMETICKETRoute::x('&comm_page=' . $i). "#$comm_ref'>$i</a></li>";
		}	
	}
	echo "</ul></div>";
}

...
<?php echo LIMETICKET_Helper::PageTitlePopup(JText::_("Select related article")); ?>
...
<form method="post" action="<?php echo LIMETICKETRoute::x('&'); ?>" id="limeticketForm" name="limeticketForm">
	...
	<div class="pull-right">
		...
		<?php if (LIMETICKET_Permission::auth("core.edit", "com_limeticket.kb")): ?>
	...
	<div class="input-append">
		<input type="text" name="search" class="input-medium" size="12" id="limeticket_search" value="<?php echo $this->filter_values['search']; ?>" placeholder="<?php echo JText::_('SEARCH'); ?>">

...
class LIMETICKETView extends JViewLegacy
{
	...
	function snip($view, $file)
	{
		...
		if (!$filename) $filename = JPATH_SITE.DS.'components'.DS.'com_limeticket'.DS.'views'.DS.$view.DS.'snippet'.DS.$file;
	...
	public function findSnip($view, $file)
	{
		...
		$paths = array(JPATH_ROOT.DS.'templates'.DS.$template.DS.'html'.DS.'com_limeticket'.DS.$view);

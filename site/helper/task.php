...
class Task_Helper
{
	...
	{
		$task = strtolower(LIMETICKET_Input::getCmd('task'));
		...
		$task_file = JPATH_SITE.DS.'components'.DS.LIMETICKET_Input::getCmd('option').DS.'views'.DS.LIMETICKET_Input::getCmd('view').DS.'task.' . $task_class . '.php';

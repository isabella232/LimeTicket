...
class LIMETICKET_Comments_Handler_KB extends LIMETICKET_Comments_Handler
{
	var $ident = 1;	
	...
	function __construct($parent) 
	{
		...
		$this->comments->use_comments = LIMETICKET_Settings::get('kb_comments');
		...
		$this->article_link = "index.php?option=com_limeticket&view=kb&kbartid={id}";

...
class SupportActions
{
	...
	{
		// load in all php files in components/com_limeticket/plugins/tickets and for each make a new object
		if (empty(self::$plugins))
		{
			...
			foreach ($files as $file)
			{
				...
				if (!LIMETICKET_Helper::IsPluignEnabled("tickets", $info['filename']))
					continue;
...
class SupportActionsPlugin extends LIMETICKET_Plugin
{
	function CanEnable()
	{
		return true;	

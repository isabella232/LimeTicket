...
class Node_Container_Document extends Node_Container
{
	...
	public static function default_bbcodes()
	{
		return array(
			...
			new BBCode('quoted', '<div class="quoted_text_cont"><span class="quoted_text_show small muted">' . \JText::_("LIMETICKET_SHOW_QUOTED_TEXT") . '</span><div class="quoted_text">%content%</div></div>'),

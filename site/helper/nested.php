...
class LIMETICKET_Nested_Helper
{
	static $id_field;
	static $par_field;
	static $order_field;
	...
	{
		usort($array, array(new LIMETICKET_Array_Obj_Sorter($field, $dir), "compare"));
	}

}


if (!class_exists("LIMETICKET_Array_Obj_Sorter"))
{
	class LIMETICKET_Array_Obj_Sorter
	{
		private $field;
		private $dir;

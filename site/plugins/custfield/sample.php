...
class SamplePlugin extends LIMETICKETCustFieldPlugin
{
	...
	{
		$params = array();
		$params['prefix'] = LIMETICKET_Input::getString('sample_prefix');
		$params['postfix'] = LIMETICKET_Input::getString('sample_postfix');

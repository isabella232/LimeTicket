<form name="adminForm" id="adminForm" class="form-condensed form-horizontal" action="<?php echo JRoute::_('index.php?option=com_limeticket&view=plugin&type=gui&name=email_ticket&tmpl=component&ticketid=' . $this->ticket->id) ?>" method="post">

<?php
echo LIMETICKET_Helper::PageStylePopup(true);
echo LIMETICKET_Helper::PageTitlePopup("EMail Ticket", $this->ticket->title);
?>
<?php LIMETICKET_Helper::IncludeChosen(); ?>

...
class LIMETICKET_GUIPlugin_EMail_Ticket extends LIMETICKET_Plugin_GUI
{
	...
	function adminTicketViewToolsMenu($ticket)
	{
		...
		// new item
		$output[] = '<li>';
		$output[] = '	<a class="show_modal_iframe" href="' . JRoute::_('index.php?option=com_limeticket&view=plugin&type=gui&name=email_ticket&tmpl=component&ticketid=' . $ticket->id) . '">';
		$output[] = 'EMail Ticket';
		$output[] = '	</a>';
		$output[] = '</li>';	
	...
	function showForm()
	{
		...
		$form_file = JPATH_SITE.DS."components".DS."com_limeticket".DS."plugins".DS."gui".DS."email_ticket".DS."form.xml";
	...
	function sendMessage()
	{
		...
		LIMETICKET_EMail_To::$only_to[$to] = "EMail Ticket";
		
		LIMETICKET_EMail::EMail_To_Ticket_Handler($tmpl, $this->ticket, "", "", array(), $vars, JFactory::getUser()->id);	

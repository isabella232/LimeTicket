...
class LIMETICKET_GUIPlugin_OpenRelatedTicket extends LIMETICKET_Plugin_GUI
{
	...
	{		
		$link = 'index.php?option=com_limeticket&view=ticket&layout=open&related=' . $ticket->id;

...
<?php foreach ($this->ticket->messages as $message): ?>
	...
	<h4><?php echo $message->subject; ?>, Posted: <?php echo LIMETICKET_Helper::TicketTime($message->posted, LIMETICKET_DATETIME_MID); ?></h4>
	<div class="bbcode well"><?php echo LIMETICKET_Helper::ParseBBCode($message->body, $message); ?></div>
<?php endforeach; ?>
